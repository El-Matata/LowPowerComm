...
#define LoRa_CS_GPIO_Port 		RF95_NCS_GPIO_Port
#define LoRa_CS_Pin 			RF95_NCS_Pin
#define LoRa_RESET_GPIO_Port 	RF95_RESET_GPIO_Port
#define LoRa_RESET_Pin 			RF95_RESET_Pin

#define RX_LED_GPIO_Port 		RF95_RX_LED_GPIO_Port
#define RX_LED_Pin 				RF95_RX_LED_Pin


#define TX_LED_GPIO_Port 		RF95_TX_LED_GPIO_Port
#define TX_LED_Pin 				RF95_TX_LED_Pin
